...
import { EditOutlined, DeleteOutlined, CaretRightOutlined, FormOutlined, ExclamationCircleFilled,PlusOutlined } from '@ant-design/icons';
        ...
        <div style={{ padding: 10 }}>
            ...
            <div style={{ marginTop: "16px", }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <h3><FormOutlined style={{ strokeWidth: "30",color:'blue',stroke:'blue',fontSize:20,fontWeight:800, marginRight:8}}/>Danh sách loại nhãn</h3>
